...
standfirst: I've put off teaching myself web development and getting smarter about data visualization for years, and for no good reason. I'm trying to change that now.
...
<figure className="">
  ...
  <figcaption>
    ...
    first times the Robinson projection was used in a report like this.
  </figcaption>
</figure>

Those graphics still have a long way to go to be accessible to the general public, I think, and to be readable on cell phones... but that's not ultimately why they're being created.
