...
One of my favorites is the [Goode homolosine](https://en.wikipedia.org/wiki/Goode_homolosine_projection), created in the 1960s by a geographer who wanted an alternative to the Mercator projection. And for decent reason: the homolosine shows areas near the polls with a lot less distortion than [Mercator](https://en.wikipedia.org/wiki/Mercator_projection) does.
...
As a grad student and postdoc, and even today when I do more technical mapping work for my job, I've always spent what feels like a LOT more time fine-tuning the maps and graphics of a paper or project than I would spend on the data analysis and research itself.
