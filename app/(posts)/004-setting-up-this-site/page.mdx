...
I've struggled to get this blog and a more DIY personal website off the ground this year. There were some personal life obstacles hindering this, but also, unless you've done it before, it's just plain hard to do. And there are a million ways to do it. And none of them seems to be the best.

It's also easy to forget how much of a struggle something like this is at first, once you figure it all out, and you soon forget all the false starts and rabbit holes you go down. So here's documentation of how I've built up this site so far, so that it helps future me, and potentially you too.

Of course, this is simply the random walk that worked for me, and it may change in the future. This is probably not an interesting thing to read unless you came here looking for more tutorial-oriented web dev stuff.

The main steps are described at length below, with useful code where necessary.
