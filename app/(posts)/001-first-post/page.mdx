...
One of my favorites is the [Good homolosine](https://en.wikipedia.org/wiki/Goode_homolosine_projection), created in the 1960s by a geographer who wanted an alternative to the Mercator projection. And for decent reason: the homolosine shows areas near the polls with a lot less distortion than [Mercator](https://en.wikipedia.org/wiki/Mercator_projection) does.
