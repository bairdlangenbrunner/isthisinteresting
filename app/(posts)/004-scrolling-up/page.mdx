...
I've been craving a way to understand and visualize the scale of these things all better. If you've taken any atmospheric or Earth science classes in your life, the image below is the standard way we're taught about atmospheric layers.
...
<figure className="">
  ...
  />
  <figcaption>
    Figure 1.9 from _Atmospheric Science: A Introductory Survey_, a classic introductory
...
I hope you like it. Let me know either way. And if you're curious what it looks like inside, the code is on GitHub [here](https://github.com/bairdlangenbrunner/scroll-up).
