...
I built my personal website using React, and this blog is built separately using Next.js. I wrote a bit more on the add-on tools I use to make these things (Tailwind CSS; MDX) in my [second blog post](https://bairdlangenbrunner.com/isthisinteresting/002-workable-blog).
